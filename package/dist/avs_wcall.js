...
var Wcall = /** @class */ (function () {
    ...
    Wcall.prototype.setMediaStreamHandler = function (mediaStreamHandler) {
        avs_pc_js_1.default.setMediaStreamHandler(mediaStreamHandler);
    };
    Wcall.prototype.replaceTrack = function (convid, newTrack) {
        avs_pc_js_1.default.replaceTrack(convid, newTrack);
    };
    Wcall.prototype.getStats = function (convid) {
        return avs_pc_js_1.default.getStats(convid);
    };
    return Wcall;
}());
exports.Wcall = Wcall;
