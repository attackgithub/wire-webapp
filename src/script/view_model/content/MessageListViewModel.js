...
class MessageListViewModel {
   ...
   * @param {MessageEntity} messageEntity - message to be focused
   ...
   * @param {MessageEntity} messageEntity - Message that should be in focus when the conversation loads
   ...
   * @param {DecryptErrorMessageEntity} message_et - Decrypt error message
   * @returns {undefined} No return value
   */
   ...
   *
   * @param {MessageEntity} message_et - Message with asset to be displayed
   ...
   * @param {MessageEntity} message_et - Message to check
   ...
   * @param {MessageEntity} messageEntity - Message to check
